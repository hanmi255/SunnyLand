...
namespace game::scene {
    ...
    MenuScene::MenuScene(engine::core::Context &context, engine::scene::SceneManager &scene_manager,
    ...
    void MenuScene::handleInput()
    {
        ...
        if (context_.getInputManager().isActionJustPressed("pause")) {
            ...
            scene_manager_.requestPopScene(); // 弹出自身以恢复底层的 GameScene
    ...
    void MenuScene::createUI()
    {
        ...
        auto pause_label = std::make_unique<engine::ui::UILabel>(
            context_.getTextRenderer(), "PAUSE", "assets/fonts/VonwaonBitmap-16px.ttf", 32);
        // 放在中间靠上的位置
        ...
        auto resume_button = std::make_unique<engine::ui::UIButton>(
            ...
            "assets/textures/UI/buttons/Resume2.png", "assets/textures/UI/buttons/Resume3.png",
            glm::vec2{button_x, start_y}, glm::vec2{button_width, button_height},
        ...
        auto save_button = std::make_unique<engine::ui::UIButton>(
            ...
            "assets/textures/UI/buttons/Save2.png", "assets/textures/UI/buttons/Save3.png",
            glm::vec2{button_x, start_y}, glm::vec2{button_width, button_height},
        ...
        auto back_button = std::make_unique<engine::ui::UIButton>(
            ...
            "assets/textures/UI/buttons/Back2.png", "assets/textures/UI/buttons/Back3.png",
            glm::vec2{button_x, start_y}, glm::vec2{button_width, button_height},
    ...
    void MenuScene::onSaveClicked()
    {
        ...
        if (session_data_ && session_data_->saveToFile("assets/data/save.json")) {
