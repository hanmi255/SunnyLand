...
namespace game::scene {
    ...
    EndScene::EndScene(engine::core::Context &context, engine::scene::SceneManager &scene_manager,
    ...
    void EndScene::createUI()
    {
        ...
        auto score_label = std::make_unique<engine::ui::UILabel>(
            context_.getTextRenderer(), score_text, "assets/fonts/VonwaonBitmap-16px.ttf",
        ...
        auto high_score_label = std::make_unique<engine::ui::UILabel>(
            context_.getTextRenderer(), high_score_text, "assets/fonts/VonwaonBitmap-16px.ttf",
            score_font_size, score_color);
        ...
        auto back_button = std::make_unique<engine::ui::UIButton>(
            ...
            glm::vec2{buttons_x, buttons_y}, button_size, [this]() { this->onBackClick(); });
        ...
        auto restart_button = std::make_unique<engine::ui::UIButton>(
            ...
            "assets/textures/UI/buttons/Restart2.png", "assets/textures/UI/buttons/Restart3.png",
            glm::vec2{buttons_x, buttons_y}, button_size, [this]() { this->onRestartClick(); });
